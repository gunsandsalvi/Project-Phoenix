...
pub fn declare(p: &mut Params) {
    ...
    say(
        ...
        "the whole weeks between a company's quarter-end and the day its accounts are published",
    );
    ...
    say(
        ...
        Kind::Resolution,
        Owner::Model,
        "the weeks a working-capital shortfall is read over, which is one period",
    );
    say(
        "funding.next_52_weeks",
        52.0,
        "weeks ahead",
        Dimension::Weeks,
        Kind::Resolution,
        Owner::Model,
        "the weeks a long-term shortfall is read over, which is a year",
    );
    ...
    say("paper.tenor", 13.0, "weeks the paper runs", Dimension::Weeks, Kind::Technology, Owner::StandardSetter,
        "how long the commercial paper a borrower brings runs for, declared once as a whole-week tenor");
    say(
        "firm.buffer",
        10.0,
        "money",
    ...
    say(
        ...
        Kind::Policy,
        Owner::Constitution,
        "the whole weeks between elections, placed by DATE and never a count of periods",
    );
    say(
        "election.takes",
        1.0,
    ...
    say("funding.tenor", 260.0, "weeks the paper runs", Dimension::Weeks, Kind::Technology, Owner::StandardSetter,
        "how long the paper an issuer brings runs for, declared once as a whole-week tenor — the tenor \
