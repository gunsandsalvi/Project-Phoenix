...
// **THE KIND COLUMNS, BESIDE THE STORES THEY NAME** (0m2.1). All four lived at the top of
...
// vocabulary of its kind column have one writer between them (Law 4), and this is it.
