...
//!
//! @spec XI-7 · XI-12 · Law 3, Law 4, Law 8, Law 19 · Appendix B
//!
...
/// XI-7: **producer prices and consumer prices are two indices**, and this is what having two buys.
/// One index wearing both names cannot show this number at all, and real growth deflated by the
/// wrong index is wrong in the same direction every time.
///
