...
/// The liability has a schedule — how much is owed in each future week — and E1: somebody NAMED is
/// owed the money.
...
pub struct Quote {
    pub by: PartyId,
    /// Its own experience, which moves toward what its weeks actually cost it.
...
/// Its experience moves toward what its weeks actually cost it — adaptively, from its own history,
...
mod tests {
    ...
    fn an_insurer_draws_its_claims_off_its_own_experience() {
        // Its own cover, its own experience, moving toward what its weeks actually cost it.
        let held = 0.04;
