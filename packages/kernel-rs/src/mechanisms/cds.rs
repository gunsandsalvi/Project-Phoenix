...
impl Contract {
    /// Real money, per week, from the buyer to the seller — and nothing once the event has fired
...
mod tests {
    ...
    fn a_book_of_hedgers_on_both_sides_does_not_clear() {
        // Its spread would be a function of regulatory gaps and never of a view, and a week in
