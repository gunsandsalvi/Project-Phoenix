...
pub struct Engagement {
    ...
    pub of: f64,
    /// Per week, in the employer's money.
    pub wage: f64,
    pub started: Week,
...
fn continuing_engagements(
    ...
    for matched in matches {
        ...
        while at < seekers.len() && places >= 1.0 {
            ...
            let taking = if available < places {
                available
            } else {
                places
            };
...
fn severance_payment(
    ...
    crate::stores::Payment {
        from,
        due,
        amount: wage_per_person * f64::from(heads) * weeks,
        of: crate::stores::Owing::Wage,
    }
}
...
mod tests {
    ...
    fn severance_is_derived_from_the_engagement_being_terminated() {
        let payment = severance_payment(700.0, 4, 3.0, Week(10), Week(17));
