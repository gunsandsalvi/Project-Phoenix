...
use phoenix_kernel::calendar::{Calendar, Week};
...
fn main() {
    ...
    let bench_calendar = phoenix_kernel::calendar::Calendar::new(phoenix_kernel::calendar::Week(0), 7);
    ...
    let mut clock = Clock::new(Calendar::new(Week(0), 7));
