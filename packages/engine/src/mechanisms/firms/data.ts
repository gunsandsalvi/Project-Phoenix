...
const STEMS: Readonly<Record<string, readonly string[]>> = {
  ...
  dwelling: ['Fairfield', 'Parkgate', 'Meadowrise', 'Hillcrest', 'Orchard', 'Kingsbury'],
...
export const LINE_SHARE: Readonly<Record<string, number>> = {
  ...
  design: 0.022360,
  dwelling: 0.029126,
  electronics: 0.009206,
  entertainment: 0.022360,
  facilities: 0.029814,
  fertiliser: 0.004296,
  flour: 0.009206,
  fuel: 0.003683,
  ...
  glass: 0.004911,
  grain: 0.026083,
  hospitality: 0.081986,
  ironOre: 0.003683,
  itServices: 0.018633,
  limestoneRaw: 0.004296,
  livestock: 0.015344,
  logistics: 0.018633,
  lumber: 0.008592,
  machine: 0.008592,
  ...
  packaging: 0.007365,
  paper: 0.006137,
  personalCare: 0.040993,
  plastic: 0.006137,
  power: 0.006137,
  professional: 0.044719,
  repair: 0.037266,
  retailAppliance: 0.011366,
  retailBread: 0.047359,
  retailClothing: 0.042623,
  retailElectronics: 0.018944,
  retailFuel: 0.014208,
  retailFurniture: 0.017050,
  retailMeat: 0.028416,
  retailMedicine: 0.011366,
  retailVehicle: 0.017050,
  rubber: 0.004296,
  security: 0.014906,
  steel: 0.006137,
  teaching: 0.022360,
