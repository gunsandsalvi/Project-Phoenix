...
Each cell is weighted by its area (the cosine of its latitude). It also prints the share of land in each terrain class
of data/shared/GEO.toml, read over windows of about 10 km (three cells of latitude by four of longitude), so the
generated map's terrain can be judged against the real ground's.
