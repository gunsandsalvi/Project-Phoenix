...
**The items broken out of that so far: 0 of 11 closed** (10 of 148 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 15 | 9 | in progress |
| 21 — The local repairs | 93 | 1 | in progress |
