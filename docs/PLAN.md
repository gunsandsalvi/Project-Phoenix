...
**The items broken out of that so far: 0 of 12 closed** (11 of 144 steps). What has closed is in `docs/RECORD.md`, not here.
...
| 22b — The chronicle — the world opens as one that has been running | 13 | 10 | in progress |
