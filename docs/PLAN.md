...
<!-- progress:start -->
**Plan completion: 71.7%** (501 of 699 steps across 45 items).
...
| [13d.1 — A cell's key carries its age, its tenure and its wealth](plan/13d.1-the-cell-key.md) | 10 | 0 | open |
