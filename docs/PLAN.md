...
**The items broken out of that so far: 0 of 8 closed** (0 of 69 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 22i — The systems that still only count | 27 | 0 | open |
