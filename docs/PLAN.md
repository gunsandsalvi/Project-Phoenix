...
**The items broken out of that so far: 0 of 16 closed** (2 of 90 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0j — Nothing checked the evidence | 7 | 2 | in progress |
...
| 0n — Value is a function, and the balance sheets must move | 5 | 0 | open |
| 0p — Every reservation is the last print times a constant | 6 | 0 | open |
| 0q — A party that ceases keeps everything it held, for ever | 3 | 0 | open |
| 0r — Twenty-two modules nothing imports | 3 | 0 | open |
...
| 17 | — | — | moved to plan 24 (The app and the APK) |
<!-- progress:end -->
...
docs/IMPLEMENTATION.md       the open items, in detail (a section is deleted when its item closes)
                             and THE ONE PLACE A FINDING LIVES: there is no second findings file
