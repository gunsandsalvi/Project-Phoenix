...
**The items broken out of that so far: 0 of 11 closed** (8 of 146 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 15 | 8 | in progress |
| 21 — The local repairs | 92 | 0 | open |
