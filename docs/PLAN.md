...
**The items broken out of that so far: 0 of 11 closed** (11 of 149 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 15 | 10 | in progress |
| 21 — The local repairs | 94 | 1 | in progress |
...
| 22c — The market as it is | 4 | 0 | open |
