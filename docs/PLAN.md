...
**The items broken out of that so far: 0 of 11 closed** (13 of 157 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 22 | 12 | in progress |
