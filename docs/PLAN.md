...
**The items broken out of that so far: 0 of 16 closed** (1 of 89 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0j — Nothing checked the evidence | 6 | 1 | in progress |
