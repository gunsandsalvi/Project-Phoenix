...
<!-- progress:start -->
**Plan completion: 17.5%** (76 of 434 steps across 27 items).
**Requirement coverage: 17.5%** (231 MET, 35 PARTIAL, 0 OUT OF SCOPE of 1323 REASON/VERIFY/FORBID clauses).
...
| [4 — Firms, goods, labour, households, outlooks](plan/04-real-economy.md) | 34 | 14 | in progress |
