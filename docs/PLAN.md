...
**The items broken out of that so far: 0 of 14 closed** (131 of 232 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 182 | 131 | in progress |
...
| 21j — Twenty-five systems take no part | 6 | 0 | open |
