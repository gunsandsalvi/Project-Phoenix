...
**The items broken out of that so far: 0 of 14 closed** (54 of 227 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 178 | 54 | in progress |
