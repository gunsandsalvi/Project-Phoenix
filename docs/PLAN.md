...
<!-- progress:start -->
**The plan: 0 of 12 items closed** (8 of 127 steps).
**Requirement coverage: 71.9%** (1002 MET, 122 PARTIAL, 2 OUT OF SCOPE of 1397 REASON/VERIFY/FORBID clauses).

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 16 | 1 | in progress |
| 17 — Corporate credit, the rest | 13 | 6 | in progress |
...
| 21 — The local repairs | 57 | 1 | in progress |
