...
<!-- progress:start -->
**The plan: 0 of 14 items closed** (6 of 120 steps).
**Requirement coverage: 69.0%** (950 MET, 112 PARTIAL, 2 OUT OF SCOPE of 1379 REASON/VERIFY/FORBID clauses).

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 16 | 1 | in progress |
| 15 — Housing and land, the rest | 7 | 4 | in progress |
...
| 21 — The local repairs | 35 | 1 | in progress |
