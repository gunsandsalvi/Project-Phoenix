...
**The items broken out of that so far: 0 of 13 closed** (39 of 221 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 177 | 39 | in progress |
