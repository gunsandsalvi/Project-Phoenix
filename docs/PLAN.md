...
**The items broken out of that so far: 0 of 9 closed** (0 of 70 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 22c2 — The standing book only grows | 3 | 0 | open |
