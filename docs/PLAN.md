...
**The items broken out of that so far: 0 of 16 closed** (7 of 93 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0j — Nothing checked the evidence | 8 | 7 | in progress |
