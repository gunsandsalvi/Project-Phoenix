...
**The items broken out of that so far: 0 of 8 closed** (0 of 50 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 22j — What the systems still do not decide | 8 | 0 | open |
