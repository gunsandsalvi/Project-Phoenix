...
<!-- progress:start -->
**Plan completion: 48.3%** (221 of 458 steps across 29 items).
...
| [10.3 — A quantity is a whole number of indivisible pieces](plan/10.3-indivisible-pieces.md) | 15 | 13 | in progress |
| [11 — Money market, corridor, bank capital](plan/11-money-market-capital.md) | 28 | 7 | in progress |
