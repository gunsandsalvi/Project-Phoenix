...
**The items broken out of that so far: 1 of 16 closed** (8 of 93 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0j — Nothing checked the evidence | 8 | 8 | closed |
