...
**The items broken out of that so far: 0 of 13 closed** (134 of 225 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 138 | 134 | in progress |
...
| 21j — Twenty-five systems take no part | 26 | 0 | open |
| 22e — The audit is not in the period loop | 6 | 0 | open |
