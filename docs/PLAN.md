...
<!-- progress:start -->
**The plan: 0 of 12 items closed** (7 of 126 steps).
**Requirement coverage: 71.8%** (1001 MET, 122 PARTIAL, 2 OUT OF SCOPE of 1396 REASON/VERIFY/FORBID clauses).

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 16 | 1 | in progress |
| 17 — Corporate credit, the rest | 13 | 5 | in progress |
...
| 21 — The local repairs | 56 | 1 | in progress |
