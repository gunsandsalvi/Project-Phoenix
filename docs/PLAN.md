...
**The items broken out of that so far: 0 of 14 closed** (62 of 228 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 179 | 62 | in progress |
