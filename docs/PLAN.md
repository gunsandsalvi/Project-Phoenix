...
**The items broken out of that so far: 0 of 11 closed** (3 of 144 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 15 | 3 | in progress |
