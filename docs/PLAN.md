...
**The items broken out of that so far: 0 of 11 closed** (27 of 214 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 177 | 27 | in progress |
