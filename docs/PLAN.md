...
<!-- progress:start -->
**The plan: 0 of 12 items closed** (6 of 125 steps).
**Requirement coverage: 71.6%** (997 MET, 124 PARTIAL, 2 OUT OF SCOPE of 1395 REASON/VERIFY/FORBID clauses).

| item | steps | done | state |
|---|---|---|---|
| 0g — The core made fast (Law 18) | 16 | 1 | in progress |
| 17 — Corporate credit, the rest | 13 | 4 | in progress |
...
| 21 — The local repairs | 55 | 1 | in progress |
