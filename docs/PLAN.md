...
**The items broken out of that so far: 0 of 14 closed** (117 of 230 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 21 — The local repairs | 181 | 117 | in progress |
...
| 21j — Twenty-five systems take no part | 5 | 0 | open |
