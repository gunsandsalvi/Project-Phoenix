...
<!-- progress:start -->
**Plan completion: 18.4%** (80 of 434 steps across 27 items).
**Requirement coverage: 22.1%** (292 MET, 43 PARTIAL, 0 OUT OF SCOPE of 1323 REASON/VERIFY/FORBID clauses).
...
| [4 — Firms, goods, labour, households, outlooks](plan/04-real-economy.md) | 34 | 18 | in progress |
