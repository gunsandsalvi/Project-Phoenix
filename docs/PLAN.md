...
**The items broken out of that so far: 0 of 15 closed** (3 of 87 steps). What has closed is in `docs/RECORD.md`, not here.

| item | steps | done | state |
|---|---|---|---|
| 0k — Money is invented, converted and misdirected | 6 | 3 | in progress |
