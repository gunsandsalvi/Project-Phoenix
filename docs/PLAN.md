...
<!-- progress:start -->
**Plan completion: 53.6%** (270 of 504 steps across 34 items).
...
| [12 — An anchored market: the second opinion, the balance sheets under it, and the currency layer](plan/12-currency-benchmarks-ratings.md) | 25 | 6 | in progress |
