...
<!-- progress:start -->
**Plan completion: 51.9%** (248 of 478 steps across 30 items).
...
| [11.1 — One bank with lines of business, and a depositor that decides from its own balance](plan/11.1-one-bank.md) | 14 | 0 | open |
