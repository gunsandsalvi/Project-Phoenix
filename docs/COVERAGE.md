...
| `Corporate Credit A3.a` | MET | packages/engine/src/mechanisms/reporting/statement.ts (interest and principal are separate lines of the cash statement, both of them money that actually left) |
