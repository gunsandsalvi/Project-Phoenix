...
- [ ] 17.7c **The covered bond**: a bank's secured funding whose pool of its own loan rows is pledged and STAYS on its book — dual recourse, the honest opposite of §42 C1's transfer into a vehicle (Banks Funding A2, C1).
- [ ] 17.7d **Senior notes and commercial paper as repo collateral** (§42 D3, Banks Funding C1.a, D1): what the secured market will take, and at what haircut.
