...
| ~~**13**~~ | Asset managers: §28, §29, §15 | `E-14` | **CLOSED.** Hedge Funds **13/24**, Prime Brokerage **17/24**, Private Equity **12/25**, Securities Lending **15/21** — from 0, 0, 0 and 14. Three of the six absent sectors this plan opened with, and **one is left** (the Polity). `E-14` closed at 13.8. **Two of its three exit sentences hold**: a hedge fund takes the speculative side of a derivative book (13.2b), and a margin call forces a sale that moves a price that calls margin on somebody else (13.4, 13.8). The third — *a buyout puts debt on a target and the credit market decides whether it happens* — is **17b** and is named there rather than claimed here |
...
**10f and 13 are closed and their sections are gone.** 10f was the owner's four corrections of
2026-09-14 — public and private firms, the IPO and the take-private, M&A as one layer with a bank's
IBD running the process, and institutions across strategies — and 13 was the three asset-management
sectors. Between them they took six of this plan's absent sectors down to ONE. Two things left them
by being POSITIONED rather than dropped: **17b**, the leveraged buyout, because the target has to
raise the debt conditional on a tender that has not settled yet and that needs 17.9's request
channel; and **item 14's** allocator, which is what §14 C3's reinvested cash collateral wants. One
thing left by being REMOVED on the owner's instruction: 13.4b, the measurement of the loss chain.
